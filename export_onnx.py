...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Output ONNX path. Defaults to <checkpoint_stem>[_fixed].onnx next to the checkpoint.",
    )
    parser.add_argument(
        "--embedding-dim",
        type=int,
...
def main():
    ...
    if args.output:
        ...
        suffix = "_fixed" if args.fixed_frames else ""
        output_path = checkpoint_path.with_name(f"{checkpoint_path.stem}{suffix}.onnx")
