...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Optional flat list of cohort audio paths (one relative path per line).",
    )
    parser.add_argument(
        "--cohort-base-path",
        type=str,
        default="",
        help="Optional base path for cohort audio. Defaults to --base-path when omitted.",
    )
...
def main():
    ...
    metrics = evaluate_trial_list(
        ...
        cohort_list_path=args.cohort_list,
        cohort_base_path=args.cohort_base_path or args.base_path,
    )
